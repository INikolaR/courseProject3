// this code was taken from https://github.com/DimaTrushin/AnyObject
...
public:
    ...
    CAnyObject(std::in_place_type_t<T>, TArgs&&... args)
        : pIObject_(std::make_unique<CObjectStored<T>>(
    ...
    void emplace(TArgs&&... args) {
        pIObject_ = std::make_unique<CObjectStored<TObject>>(
            std::forward<TArgs>(args)...);
    }
...
private:
    ...
    private:
        ...
        CObjectKeeper(const CObjectType& Object,
                      std::integer_sequence<size_t, TIndex...>)

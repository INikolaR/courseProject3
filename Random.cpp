...
std::vector<double> Random::generateNormal(In in, Out out) {
...
std::vector<double> Random::generateKaiming(In in, Out out) {
...
std::vector<double> Random::generateXavier(In in, Out out) {

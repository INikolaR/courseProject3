...
DataLoader parser::parseMNISTDataset(const std::string& path_to_images_file,
...
TrainTestLoaders parser::parseTitanicDataset(const std::string& filename) {
...
TrainTestLoaders parser::parseBostonDataset(const std::string& filename) {
    std::ifstream fin(filename, std::ifstream::in);
